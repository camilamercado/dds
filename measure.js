function position() {
		...
		var pos2 = (Math.random() * (max - min) + min);
		var pos3 = (Math.random() * (max - min) + min);
		var pos4 = (Math.random() * (max - min) + min);
		console.log(pos);

		// document.getElementById('x').style.top= pos+"px";
		// document.getElementById('x').style.left= pos2+"px";
	...
	function distance(){		
	    ...
	    // var angle = Math.atan2((y-distY),(X-distX))*(180/Math.PI);
	    // console.log(angle);

	    var distX = getDistance(document.getElementById("z"),
	    document.getElementById("x"));
	    var distY = getDistance(document.getElementById("z"),
